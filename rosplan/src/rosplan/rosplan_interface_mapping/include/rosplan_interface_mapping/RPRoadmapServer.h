...
namespace KCL_rosplan {
	...
	public:
		...
		void createPRM(nav_msgs::OccupancyGrid map, unsigned int nr_waypoints, std::vector<float_t> waypoints_x, std::vector<float_t> waypoints_y, double min_distance, double casting_distance, double connecting_distance, int occupancy_threshold, int total_attempts);
	};
}
#endif
