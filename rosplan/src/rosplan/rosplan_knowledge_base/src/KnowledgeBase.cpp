...
namespace KCL_rosplan {
	...
	bool KnowledgeBase::updateKnowledge(rosplan_knowledge_msgs::KnowledgeUpdateService::Request &req, rosplan_knowledge_msgs::KnowledgeUpdateService::Response &res) {
		...
		// printf("[DEBUG] updateKnowledge Service call\n");
		// printf("[DEBUG] update_type: %d\n", req.update_type);
		// printf("[DEBUG] knowledge_type: %d\n", req.knowledge.knowledge_type);
		// printf("[DEBUG] instance_type: %s\n", req.knowledge.instance_type.c_str());
		// printf("[DEBUG] instance_name: %s\n", req.knowledge.instance_name.c_str());
		// printf("[DEBUG] attribute_name: %s\n", req.knowledge.attribute_name.c_str());
		// for(int j=0 ; j<req.knowledge.values.size() ; j++)
		// {
		// 	printf("[DEBUG]  - key,value: %s / %s\n", req.knowledge.values[j].key.c_str(),req.knowledge.values[j].value.c_str());
		// }
