#include "rosplan_interface_movebase/enterev.h"

/* The implementation of RPMoveBase.h */
namespace KCL_rosplan {

	/* constructor */
	RPEnterEV::RPEnterEV(ros::NodeHandle &nh, std::string &actionserver)
	...
	bool RPEnterEV::concreteCallback(const rosplan_dispatch_msgs::ActionDispatch::ConstPtr& msg) 
	{
		...
		// action name: enterev
		// key: r / value: anv
		// key: from / value: doorway113
		// key: to / value: elevator2
		// key: floor / value: floor1
	...
	int main(int argc, char **argv) {
		...
		ros::init(argc, argv, "rosplan_interface_semantic_slam_enterev");
		ros::NodeHandle nh("~");

		std::string actionserver;
		nh.param("action_server", actionserver, std::string("/enter_elevator"));

		// create PDDL action subscriber
		KCL_rosplan::RPEnterEV rpmb(nh, actionserver);
