...
namespace KCL_rosplan {
	...
	class RPGotoCheckpoint: public RPActionInterface
	{

	private:

		mongodb_store::MessageStoreProxy message_store;
		actionlib::SimpleActionClient<semantic_slam_msgs::goto_checkpointAction> action_client;
		ros::ServiceClient clear_costmaps_client;

	public:

		/* constructor */
		RPGotoCheckpoint(ros::NodeHandle &nh, std::string &actionserver);
